...
-- Set the python3 virtual environment for Neovim
vim.g.python3_host_prog = '/Users/john/.venvs/nvim/bin/python'
--[[
...
require('lazy').setup({
  ...
  --
  -- NOTE: Merged with gitsigns.lua in plugins folder
  --
    ...
    config = function()
      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          ...
          -- Noops to make sure typesctipt-tools gets used instead
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      completion = {
        ...
        -- Disable auto-show for wiki files
        menu = {
          auto_show = function(ctx)
            -- Don't auto-show for wiki files, but allow for others
            return not vim.tbl_contains({ 'vimwiki', 'wiki' }, vim.bo.filetype)
          end,
        },
      },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      indent = { enable = true, disable = { 'ruby', 'yaml', 'helm' } },
    },
